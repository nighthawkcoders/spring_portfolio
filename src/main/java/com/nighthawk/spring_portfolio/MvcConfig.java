...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(@NonNull CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("https://nighthawkcoders.github.io", "http://127.0.0.1:4100", "http://localhost:4100", "http://localhost:8085", "http://127.0.0.1:8085", "https://spring.nighthawkcodingsociety.com");
    }
