...
public class ArrayTest {
    ...
    public static void changeArray(String[] aLocalRef, ArrayTest aObject) {
        ...
        System.out.println("\t changeArray method before: sObject.s = " + Arrays.toString(aObject.arr) + ", hash = " + System.identityHashCode(aObject));
        ...
        System.out.println("\t changeArray method after: aObject.s = " + Arrays.toString(aObject.arr) + ", hash = " + System.identityHashCode(aObject));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("main method before: sValue = " + Arrays.toString(arr)  + ", hash = " + System.identityHashCode(arr));
        System.out.println("main method before: sObject.s = " + Arrays.toString(aObject.arr) + ", hash = " + System.identityHashCode(aObject));
